...
const playlist = {
    ...
    tracksList  : {
        ...
        waypointScroller: {
            ...
            defaultMaxAngle: Math.PI / 2.5 // Angle par defaut au defilement maximum du chariot de defilement de la liste des pistes (en radians).
        },
        item            : {
...
playlist.tracksList.close.angularHeight            = Math.asin((playlist.tracksList.close.height / 2)
                                                               / playlist.tracksList.size) * 2 // Hauteur angulaire du bouton de fermeture de la liste des pistes (en radians).
playlist.tracksList.waypointScroller.angularHeight = Math.asin((playlist.tracksList.waypointScroller.height / 2)
                                                               / playlist.tracksList.size) * 2 // Hauteur angulaire du chariot de defilement de la liste des pistes (en radians).
playlist.tracksList.item.angularHeight             = Math.asin((playlist.tracksList.item.height / 2)
                                                               / playlist.controlPanel.size) * 2 // Hauteur angulaire d'un element de la liste des pistes (en radians).
